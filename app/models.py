...
class Shape(db.Model):
    ...
    ra_xy = db.Column(db.Float)
    dec_xy = db.Column(db.Float)
    theta = db.Column(db.Float)
    xw = db.Column(db.Float)
    yh = db.Column(db.Float)
    ra_wh = db.Column(db.Float)
    dec_wh = db.Column(db.Float)
    ...
    ra1 = db.Column(db.Float)
    ra2 = db.Column(db.Float)
    ra3 = db.Column(db.Float)
    dec1 = db.Column(db.Float)
    dec2 = db.Column(db.Float)
    dec3 = db.Column(db.Float)
    x_points = db.Column(psql.ARRAY(db.Float))
    y_points = db.Column(psql.ARRAY(db.Float))
    ra_points = db.Column(psql.ARRAY(db.Float))
    dec_points = db.Column(psql.ARRAY(db.Float))
